        ...
        <motion.div 
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
            ...
            <div className="flex justify-center pt-6">
              <button 
                type="submit"
                className="w-full md:w-auto min-w-[220px] bg-[#0071e3] hover:bg-[#0077ed] text-white font-bold py-4 px-12 rounded-full text-[17px] transition-all active:scale-95 shadow-xl shadow-blue-500/20">
                Send Message
              </button>
            </div>
          </form>
